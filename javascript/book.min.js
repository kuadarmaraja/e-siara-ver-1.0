...
this.getBottomHeight()},getWidth:function(){return this.getLeftWidth()+this.getRightWidth()}};window.templeteName="brief";
window.templateArea={getLeftWidth:function(){return 0},getRightWidth:function(){return 0},getTopHeight:function(){return MiniStyle.isMini()||NeatStyle.isNeat()||!bookConfig.ToolBarVisible?0:isPC()?40:phoneTemplateArea.getTopHeight()},getBottomHeight:function(){return MiniStyle.isMini()?0:NeatStyle.isNeat()?40:bookConfig.ToolBarVisible?isPC()?40:phoneTemplateArea.getBottomHeight():0},getHeight:function(){return this.getTopHeight()+this.getBottomHeight()},getWidth:function(){return this.getLeftWidth()+this.getRightWidth()}};/*
