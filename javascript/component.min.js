...
f.callWhenSettled_(h.resolve,h.reject)};e.prototype.settleSameAsThenable_=function(f,h){var k=this.createResolveAndReject_();try{f.call(h,k.resolve,k.reject)}catch(l){k.reject(l)}};e.prototype.then=function(f,h){function k(n,q){return"function"==typeof n?function(r){try{l(n(r))}catch(t){m(t)}}:q}var l,m,p=new e(function(n,q){l=n;m=q});this.callWhenSettled_(k(f,l),k(h,m));return p};e.prototype.catch=function(f){return this.then(void 0,f)};e.prototype.callWhenSettled_=function(f,h){function k(){switch(l.state_){case 1:f(l.result_);
...
b/a,2)}:{width:Number.fixed(11.3*a/b,2),height:11.3}},printPages:function(a){var b=this,c,d,e,g,f,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(!a||!a.length||!parseBool(bookConfig.PrintButtonVisible))return k.return();b.initLoadPrint();c=0;b.printArea.empty();b.printArray=[];d=function(l,m,p,n){var q=this,r,t,w,x,v;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){switch(u.nextAddress){case 1:return r=$("<div style='position:relative;width:100%;height:100%;'></div>"),
t=$(p),l&&-1<l.indexOf("none")&&!l.startsWith("data:image")&&m&&0>m.indexOf("none")&&(t=$(m)),void 0===n&&(n=p),u.setCatchFinallyBlocks(2),u.yield(q.createCompositeImage(t,l),4);case 4:(w=u.yieldResult)&&(t=$(w));u.leaveTryBlock(3);break;case 2:x=u.enterCatchBlock(),console.error("Canvas\u935a\u581f\u579a\u6fb6\u8fab\u89e6:",x);case 3:r.append(t);$(t).parent().css({"text-align":"center",width:"100%",height:"100%"});t.css({"text-align":"center","max-width":"100%","max-height":"100%"});"stretch"===
bookConfig.printBackgroundPosition?t.css({width:"100%",height:"100%"}):"fill"===bookConfig.printBackgroundPosition?t.css({width:"100%",height:"100%","object-fit":"cover"}):$(t).parent().css({display:"flex","justify-content":"center","align-items":"center"});q.printArray[n]=r;c++;if(c==a.length){for(v=0;v<q.printArray.length;v++)q.printArray[v]&&q.printArea.append(q.printArray[v]);q.printArea.printArea({onReady:q.hidePrintLoading.bind(q)})}u.jumpToEnd()}})};e=BookInfo.getBook().pageWidth;g=BookInfo.getBook().pageHeight;
f={};for(h=0;h<a.length;f={$jscomp$loop$prop$page$2:f.$jscomp$loop$prop$page$2},h++)f.$jscomp$loop$prop$page$2=a[h],getPageDir(f.$jscomp$loop$prop$page$2,"normal").then(function(l){return function(m){var p=e,n=g;if(bookConfig.normalSuffix&&"zip"===bookConfig.normalSuffix||-1<m.indexOf("zip"))window.printLoadStack||b.initPrintStack(a),p=2*e,n=2*g;"object"!=typeof m&&m.match(/none/)?b.getPrintImgType(l.$jscomp$loop$prop$page$2).then(function(q){pageResourceLoad(l.$jscomp$loop$prop$page$2,q,d.bind(b),
p,n)}):pageResourceLoad(l.$jscomp$loop$prop$page$2,"normal",d.bind(b),p,n)}}(f));k.jumpToEnd()})},createCompositeImage:function(a,b){var c=this;return new Promise(function(d,e){try{var g=document.createElement("canvas"),f=g.getContext("2d"),h=new Image;h.crossOrigin="anonymous";h.onload=function(){var k,l,m,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==n.nextAddress)return n.setCatchFinallyBlocks(2),g.width=h.naturalWidth,g.height=h.naturalHeight,f.drawImage(h,0,0),n.yield(c.createWatermarkWithPageWatermark(h.naturalWidth,
...
c=function(){var e,g,f,h,k,l,m,p,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return b.verify=!0,e="","downloadAll"==b.downloadButton.downloadType&&(e=b.downloadconfig.pdf.url),"downloadCurrent"!=b.downloadButton.downloadType?q.jumpTo(2):q.yield(getPageDir(b.pageIndex,"normal"),3);2!=q.nextAddress&&(e=q.yieldResult);"downloadAttachments"==b.downloadButton.downloadType&&(e=b.selectAttachments[0].value);if("object"==typeof e)if("downloadCurrent"==b.downloadButton.downloadType)b.loadImage(e,
...
"normal",windowWidth,windowHeight,function(r){r=$("<a href="+r.toDataURL("image/png")+' download="page'+this.pageIndex+'.png"></a>');r[0].click();r.remove()}.bind(b)),b.downloadPdfLoadingTask.start();else if(-1<e.indexOf(".js"))pageResourceLoad(b.pageIndex,"normal",function(r,t,w,x){r=$("<a href="+r+' download="page'+this.pageIndex+'.png"></a>');r[0].click();r.remove()}.bind(b));else if("downloadCurrent"==b.downloadButton.downloadType&&isSupportWebp&&!bookConfig.isEncryptionBook&&(e=e.removeStartFrom("?"),
...
b.downloadButton.downloadType&&(m=b.currentAttachmentName||"");if(location.protocol.match("file:"))return/^\/\//i.test(e)&&(e="https://"+e),window.open(e),q.return();if("downloadAll"==b.downloadButton.downloadType)return"English"==UserGroups&&(p=window.share_url||window.location.href,e=e.replace(/bookId=\d+/,"bookUrl="+encodeURIComponent(p))),bookConfig.isEncryptionBook&&(n=BookRestrict.getRestrictToken(),e=appendParamToUrl(e,"code="+n)),window.open(e,"_blank"),q.return();if(isAndroid()&&isWeChat()||
...
this.analysisShare=new AnalysisShare;this.shareList=this.analysisShare.getList();this.getQrCodeVisible=this.shareList.length&&this.shareList.find(function(a){return"qrcode"==a.type})||bookConfig.SmallProgramUrl;this.sharePanelTitle=$("<div class='link_title share_title'>"+getLanguage("frmPanelTitle","Share to")+":</div>");this.linkBox=$("<div class='link_Box'></div>");this.linkTitle=$("<div class='link_title'>"+getLanguage("frmLinkLabel","Link")+":</div>");this.linkArea=$("<input aria-label='"+getLanguage("ariaShareLink",
"Book link")+"' class='link_input'></input>");this.copy1=$("<div role='button' tabindex=0 aria-label='"+getLanguage("ariaCopy","copy")+"' class='copy button_hover'>"+getLanguage("lblCopy","Copy")+"</div>");this.codeBox=$("<div class='codeBox'></div>");this.codeButton=$("<div class='codeButton'><span class='qrcode active' title="+getLanguage("frmShareQRcode","QRCode")+">"+getLanguage("frmShareQRcode","QRCode")+"</span><span class='miniProgram' title="+getLanguage("frmShareSmallProgram","smallProgram")+
">"+getLanguage("frmShareSmallProgram","smallProgram")+"</span></div>");this.shareCode=$("<div class='shareCode' style='cursor:pointer;'><div class='QRcode' style='width:100px;height:100px;'></div></div>");this.miniProgramCode=$("<div class='miniProgramCode' style='background:url("+bookConfig.SmallProgramUrl+") center center no-repeat;background-size:cover'></div>");this.shareCode.find(".QRcode").qrcode({width:100,height:100,render:global.isIE8()?"":"image",text:share_url});this.hasQrcode()&&this.codeBox.append(this.shareCode);
bookConfig.SmallProgramUrl&&this.codeBox.append(this.miniProgramCode);this.codeBox.append(this.codeButton);this.bigCodeBox=$("<div class='bigCodeBox' style='display:none;position:absolute;width:160px;height:160px;top:-41px;border:1px solid #dedede;padding:10px;background-color:#fff;border-radius:2px'></div>");this.bigMiniProgramCode=$("<div class='bigMiniProgram' style='display:none;position:absolute;width:180px;height:180px;top:-29px;border:1px solid #dedede;background:url("+bookConfig.SmallProgramUrl+
...
text:c});this.shareCode.find(".QRcode").empty().qrcode({width:100,height:100,render:global.isIE8()?"":"image",text:c})},addItem:function(a){var b=this;if(!this.added&&(this.added=!0,this.sharePanel.hide(),this.shareList&&!(0>this.shareList.length))){var c=this.shareList.filter(function(h){return"mobile"===h.filter&&!isPC()||"pc"===h.filter&&isPC()?!1:!0});if(c.length){this.loading=$('<img src="'+uiBaseURL+'loading.gif" style="position: absolute;left: 0;top: 0;right: 0;bottom: 0;margin: auto;"/>');
$(this.sharePanel[0].parentElement.parentElement).append(this.loading);for(var d=0;d<c.length;d++){var e=c[d];e.type&&"copy"==e.type?(e=$("<a aria-label='"+e.title+"' tabindex='0' class='share-item' id='copy_url' data-clipboard-action='copy' title='"+e.title+"'>\n            <img src='"+e.logo+"'/>\n          </a>"),copyHref(e[0])):e=-1<e.url.indexOf("javascript")?$("<a aria-label='"+e.title+"' tabindex='0' class='share-item' onclick='"+e.url.remove("javascript:")+";return false;' title='"+e.title+
"'>\n            <img src='"+e.logo+"'/>\n          </a>"):$("<a aria-label='"+e.title+"' tabindex='0' class='share-item' target = '_blank' href='"+e.url+"' title='"+e.title+"'>\n            <img src='"+e.logo+"'/>\n          </a>");this.sharePanel.append(e);this.itemArray.push(e);var g=this;e.bind(_event._end,function(){var h=$(this).attr("title");BookEvent.trigger("share",[BookInfo.getCurrentPageIndex(),h,g.shareCurrentChecked])})}var f=0;for(c=0;c<this.itemArray.length;c++)e=this.itemArray[c],
e.find("img")[0].onload=function(){f++;f==b.itemArray.length&&(b.loading.remove(),b.sharePanel.show(),a&&a())}}else this.sharePanel.show(),null==(d=this.codeBox)||d.css({left:"50%",transform:"translateX(-50%)"}),a&&a(!0)}},initEvent:function(a){this.copy1.bind(_event._click,function(){BookEvent.trigger("share",[BookInfo.getCurrentPageIndex(),getLanguage("lblCopy","Copy"),self.shareCurrentChecked]);this.copyFrom(this.linkArea)}.bind(this));this.linkArea.bind(_event._click,function(){this.linkArea.select()}.bind(this));
...
!1,this.elements.shareCurrentChecked?this.shareCurrentCheck.attr("src",this.elements.searchOnUrl):this.shareCurrentCheck.attr("src",this.elements.searchOffUrl))},changeIconColor:function(){this._super();this.changeItemColor()},changeItemColor:function(){this.elements.fontColor=this.fontColor;this.shareCurrentCheck.changeButtonColor(this.fontColor)},onShow:function(){var a=this;this.changeIconColor();this.shareStage.refreshData();this.elements.addItem(function(b){a.stage[0].style.display="inline-block";
a.setA11yAndFocus();var c;b&&(null==(c=a.swiperContainer)?0:c.length)&&a.swiperContainer.css({display:"none"})})}}).extend(FadeOutFadeForm),PhoneShareForm=Class({create:function(a){this.elements=new ShareElements(this);this._super(a)},onCreate:function(){this.stage.css({color:this.fontColor});this.close.changeButtonColor(this.fontColor);this.back.css({color:this.fontColor});this.favicon&&this.favicon.changeButtonColor(this.fontColor);this._super()},initHtml:function(){var a="Back";"Chinese"==UserGroups&&
(a="\u8fd4\u56de");a=getLanguage("btnBack",a);this.back=$("<div class='back'><img src='"+(window.zoom_icons&&zoom_icons["arrow-left"]?"data:image/png;base64,"+zoom_icons["arrow-left"]:uiBaseURL+"arrow-left.png")+"'/><span>"+a+"</span></div>");this.stage.append(this.back);this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.qrcode);this.hideQRCode()},initSwiper:function(){this.shareSwiper=
$("<div class='shareSwiper stage'></div>");this.shareSwiperList=$("<div class='swiper'></div>");this.refreshSwiper(this.shareSwiperList,this.shareList);this.shareSwiper.append(this.shareSwiperList);isPhone()||isPad()?this.shareSwiper.css({"overflow-y":"auto","overflow-x":"hidden","-webkit-overflow-scrolling":"touch"}):(this.shareSwiper.css({overflow:"hidden"}),this.shareSwiperList.css({top:0,left:0,width:"100%",position:"absolute"}),this.progress=$("<div class='progress'></div>"),this.progressBar=
$("<div class='progressBar'></div>"),this.shareSwiper.append(this.progress),this.progress.append(this.progressBar),this.shareSwiper.scroll({},Direction.top));this.stage.append(this.shareSwiper)},refreshSwiper:function(a,b){for(var c=b.length,d=0;d<c;d++)this.addItem(a,b[d])},addItem:function(a,b){b&&(b.fontColor=this.fontColor,(new PhoneShareItem(b)).appendTo(a))},refresh:function(){isPhone()||isPad()||!this.shareSwiper||this.shareSwiper.refreshData()},initEvent:function(){this.back.onTap(function(){this.hideQRCode()}.bind(this))},
...
a)},refreshPanel:function(){this.refresh();this.refreshListPanel();var a;null==(a=BookInfo.getBook().bookAttachments)||a.Items.find("BookmarkTab").each(function(b){b.reload()})},onResize:function(a,b){this.maxHeight=b;this.bookmarkSwiper.css("height",b+"px")},refreshSideEdge:function(a){var b={};if(void 0===a?0:a)b.bookmarkHeight=0;setBookVerticalMargin(b)}}),PhoneBookmarkListPanel=Class({create:function(a){this._super(a)},onCreate:function(){},newItem:function(a){return new PhoneBookmarkItem(a,this.callback)}}).extend(BookmarkListPanel),
...
TableOfContentItem=Class({create:function(a,b,c){this.callback=c;this.level=parseInt(ols[0].level)?parseInt(b.level):parseInt(b.level)+1;this.children=[];this.parent=a;this.parm=b;this.parm.caption=HTMLString.toText(this.parm.caption);this.hasChild=b.children&&0<b.children.length;this.item=$("<li aria-label='"+getLanguage("ariaPage","page")+" "+this.parm.page+"' class='item'></li>");this.fontColor=b.fontColor;this.colorObj=Color(this.fontColor);this.initArrowUrl();this.initDefaultDom();this.initHtml(a,
...
function resizeComponents(){if(global.printBody)printBody.onResize();if(global.downLoadBody)downLoadBody.onResize();if(global.helpBody)helpBody.onResize();if(global.aboutBody)aboutBody.onResize();if(global.sharePanel)sharePanel.onResize();if(global.languagePanel)languagePanel.onResize();if(global.frmTableOfContent)frmTableOfContent.onResize();if(global.bookmark)bookmark.onResize();if(bookConfig.AnnotationButtonVisible&&global.annotationPannel)global.annotationPannel.onResize()};var PcAboutForm=Class({onCreate:function(){this._super()},onResize:function(){this.width=Math.min(windowWidth-65,340);this.height=windowHeight;this.stage.css({left:windowWidth+"px",width:this.width+"px",height:this.height+"px"});var a=this.visible?transformCSS({tran:{x:-this.width,y:0}}):transformCSS({tran:{x:0,y:0}});this.stage.css(a);this.parent.css(a)}}).extend(PhoneAboutForm);var PcBookmarkForm=Class({onResize:function(){this.width=Math.min(windowWidth-65,340);this.height=windowHeight;this.stage.css({left:windowWidth+"px",width:this.width+"px",height:this.height+"px"});var a=this.visible?transformCSS({tran:{x:-this.width,y:0}}):transformCSS({tran:{x:0,y:0}});this.stage.css(a);this.parent.css(a)}}).extend(PhoneBookmarkFrame);var PcHelpForm=Class({create:function(a){this.elements=new HelpElements(this);this._super(a)},onCreate:function(){this.stage.css({"background-color":this.mainColor,color:this.fontColor});bookConfig.helpContentFileURL&&this.stage.css({width:bookConfig.helpWidth+"px",height:bookConfig.helpHeight+"px"});this._super();bookConfig.showHelpContentAtFirst?this.show():this.hide()},initHtml:function(){this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):
this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.image);this.title1&&this.stage.append(this.title1);this.title2&&this.stage.append(this.title2);this._super()},onResize:function(){this.width=Math.min(windowWidth-65,340);this.height=windowHeight;this.stage.css({left:windowWidth+"px",width:this.width+"px",height:this.height+"px"});var a=this.visible?transformCSS({tran:{x:-this.width,y:0}}):transformCSS({tran:{x:0,y:0}});this.stage.css(a);this.parent.css(a)},onShow:function(){this.close.changeButtonColor(this.fontColor);
this.favicon&&this.favicon.changeButtonColor(this.fontColor);!bookConfig.helpContentFileURL&&this.image&&this.image.changeButtonColor(this.fontColor)}}).extend(FadeOutFadeForm);var PcPrintForm=Class({onResize:function(){this.width=Math.min(windowWidth-65,340);this.height=windowHeight;this.stage.css({left:windowWidth+"px",width:this.width+"px",height:this.height+"px"});var a=this.visible?transformCSS({tran:{x:-this.width,y:0}}):transformCSS({tran:{x:0,y:0}});this.stage.css(a);this.parent.css(a)}}).extend(PhonePrintForm);var PcTableOfContentForm=Class({onResize:function(){this.width=Math.min(windowWidth-65,340);this.height=windowHeight;this.stage.css({left:windowWidth+"px",width:this.width+"px",height:this.height+"px"});var a=this.visible?transformCSS({tran:{x:-this.width,y:0}}):transformCSS({tran:{x:0,y:0}});this.stage.css(a);this.parent.css(a);this.stage.scroll({},Direction.top)},onResize:function(){this.width=Math.min(windowWidth-65,340);this.height=windowHeight;this.stage.css({left:windowWidth+"px",width:this.width+
"px",height:this.height+"px"});var a=this.visible?transformCSS({tran:{x:-this.width,y:0}}):transformCSS({tran:{x:0,y:0}});this.stage.css(a);this.parent.css(a);this.tableofcontentSwiper.css({height:this.height-135+"px",overflow:"hidden"});this.input.css("width",this.width-75+"px");this.elements.refresh()}}).extend(PhoneTableOfContentForm);var PcVideoGalleryForm=Class({create:function(a){this.elements=new VideoGalleryElements(this);this._super(a)},onCreate:function(){this.stage.css({"background-color":this.mainColor,color:this.fontColor});this._super()},initHtml:function(){this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.video);this.stage.append(this.info);if(this.videoList&&
1<this.videoList.length){var a=$("<div class='video_list'></div>");a.append(this.videoListTitle);a.append(this.videoSwiper);this.stage.append(a)}else this.stage.css("width","335px");this._super()},onShow:function(){this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.elements.playVideo(this.videoList[0]);this.videoList&&1<this.videoList.length&&this.videoSwiper.refreshData()},onHide:function(){this.video.attr("src","")}}).extend(FadeOutFadeForm);var PcShareForm=Class({}).extend(PhoneShareForm);var PcDownloadForm=Class({onResize:function(){this.width=Math.min(windowWidth-65,340);this.height=windowHeight;this.stage.css({left:windowWidth+"px",width:this.width+"px",height:this.height+"px"});var a=this.visible?transformCSS({tran:{x:-this.width,y:0}}):transformCSS({tran:{x:0,y:0}});this.stage.css(a);this.parent.css(a)}}).extend(PhoneDownloadForm);
